...
sudo docker run --name=research35.web --link=research35.db -d -p 0.0.0.0:8080:80 bowen/research35.web 'python3' '/usr/local/research35/web/manage.py' 'runserver' '0.0.0.0:80'
